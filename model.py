...
#     print('argment', augment)
    if augment:
        aug_tfms = [
#             RandomRotate(20, tfm_y=TfmType.NO),
            RandomFlip(),
...
class MaskRCNN():
    ...
    def find_last(self, searchdir = None):
        ...
        if searchdir is None:
            ...
            if not dir_names:
                print('no dir in search path', searchdir)
                return None, None
            # Pick last directory
        ...
        if not checkpoints:
            print('not checkpoints search path', searchdir)
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers, argument = True):
        ...
        if os.name is 'nt':
            ...
            workers = max(self.config.BATCH_SIZE // 2, 4)
...
#         self.keras_model.save(os.path.join(
#             self.log_dir,'{}_{}.h5'.format(self.config.NAME.lower(), layer_name)))
